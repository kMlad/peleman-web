...
function RequirementsFormBlock({
  ...
  const handleSubmit = async (values: Values) => {
    ...
    await validationSchema.validate(data).catch((err) => console.log(err));
  };
  ...
  return (
    <div className="h-full w-full bg-darkNavy  lg:h-[440px]">
      <div className="container mx-auto py-[20px] lg:py-[95px]">
        <div className="flex flex-col justify-between lg:flex-row  ">
          <div>
            ...
            <div className="  w-[100%]  text-base font-thin leading-5 text-white">
              <div>{description}</div>
            </div>
          </div>
          <form
          ...
          >
            ...
            <div className="mt-5 mb-12  flex items-start pr-0  lg:items-end lg:self-end">
              <button
                type="submit"
                className=" rounded-full border-2 border-orange bg-orange  px-[35px] py-[10px] text-sm text-white transition  duration-500 hover:border-2 hover:border-orange hover:bg-transparent hover:text-orange md:text-lg lg:px-[40px] lg:py-[10px]"
              >
                Submit
              </button>
            </div>
