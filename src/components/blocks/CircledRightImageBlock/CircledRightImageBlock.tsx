    ...
    <>
      <div className="container mx-auto my-20 flex flex-col-reverse items-center gap-x-20 md:flex-row lg:gap-x-32 xl:gap-x-40">
        <div className="flex w-full basis-[67%] ">
          <div className="">
            <h3 className=" mt-12 mb-4 w-[90%] stroke-black text-xl font-semibold text-darkGrey md:text-2xl">
              {title}
            </h3>
            <div className=" mb-11 w-full text-base font-light leading-8 prose-a:text-orange prose-a:underline prose-strong:font-bold prose-ul:list-disc">
