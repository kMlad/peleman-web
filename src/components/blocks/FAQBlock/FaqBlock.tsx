                ...
                <div className="flex flex-col items-center">
                  <div className="flex flex-row rounded-lg shadow-custom ">
                    <button
                      ...
                      w-[17.875rem] items-center justify-center gap-2 self-center rounded-lg bg-white px-4 text-center text-base font-normal text-darkGrey focus:border-2 focus:border-orange"
                      type="button"
                            ...
                            <li
                              className={`${
                                activeDropdownItem == dataItem?.title
                                  ? 'font-bold text-lightNavy'
                                  : ''
                              }  flex w-full cursor-pointer justify-center bg-white p-2 text-base font-normal text-darkGrey`}
                              key={index}
                              onClick={() => {
                    ...
                    <div
                      ...
                      className={`${
                        activeTab === index
                          ...
                          : 'font-light text-darkGrey'
                      } my-1 mt-6 cursor-pointer text-center text-2xl font-light  hover:font-medium hover:text-orange sm:text-left sm:text-[26px]`}
                    >
                      {item?.title}
                    </div>
                  );
