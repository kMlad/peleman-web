        ...
        <div className="m-auto w-[16.75rem] rounded-2xl shadow-custom">
          ...
          <div className="flex flex-col">
            <div className="m-auto grid w-[16.75rem] content-between rounded-b-2xl bg-white py-5 sm:h-[630px]">
              <div>
                <p className="mb-4 text-center text-xl font-normal text-darkGrey">
                  {data.map((item, idx) => (
                    <p
                      key={idx}
                ...
                <p className="text-center text-lg font-bold text-darkGrey/70 line-through">
                  {data.map((item, idx) =>
                    item.sale === 0 ? (
                      <p
                        key={idx}
                ...
                <p className="-m-5 text-center  text-[45px] font-bold">
                  {data.map((item, idx) =>
                    item.sale === 0 ? (
                      <p
                        key={idx}
                ...
                <p className="mb-[57px] mt-6 flex justify-center">
                  {data.map((item, idx) => (
                    <p
                      key={idx}
                      className={`${idx === activeTab ? '' : 'hidden'} `}
