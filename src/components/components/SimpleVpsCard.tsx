        ...
        <h3
          className={`w-full ${
            aligment === 'right'
              ...
              ? 'text-left'
              : 'text-center'
          } mt-8 mb-6 text-[18px] font-semibold text-darkGrey sm:text-[26px]`}
        >
          {title}
        </h3>

        <button
          className=" inline-flex items-center rounded-lg px-4 text-center  text-base font-semibold text-darkGrey  "
          type="button"
