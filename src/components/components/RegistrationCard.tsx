          ...
          <div className="w-[340px] rounded-b-2xl  bg-lightNavy/10 py-4 md:w-[390px]">
            <div className="flex flex-col items-center">
              <div className="flex flex-row ">
                <button
                  className="mt-1 inline-flex h-16 w-[295px] items-center justify-center  self-center rounded-lg bg-white px-4 text-center  text-base font-semibold text-darkGrey  "
                  type="button"
